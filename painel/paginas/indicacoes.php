	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Editar Nome indicado - <span id="nome_indicado"> </span></h4>
			...
			<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-12">	
							<div class="form-group"> 
								<label>Novo Nome do Indicado</label> 
								<input type="text" class="form-control" name="nome_indicado" id="nome_indicado" > 
							</div>	
						</div>
					...
					<div class="row">
						...
						<div class="col-md-12" style="margin-top: 22px;" align="right">							
			...
			<div class="modal-body">
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">						
							<div class="form-group"> 
								<label>Status <small>Selecione o Status</small></label> 
								<select name="status-aprovar" class="form-control" id="status-aprovar">
									<option value="Aprovado">Finalizado</option>
									<option value="Cancelado">Cancelado</option>
									<option value="Aguardando" selected>Aguardando</option>
									<option value="Em contato">Em Contato</option>
									<option value="Instalação Encaminhada">Instalação Encaminhada</option>
									<option value="Instalação Concluída">Instalação Concluída</option>
									<option value="Indicação Premiada">Indicação Premiada</option>
