...
for($i=0; $i<$linhas; $i++){
    ...
    if($status == 'Cancelado'){
        ...
        $excluir = 'ocultar';
        $icone = 'fa-square';       
        $classe_square = 'amarelo';
        $classe_nome = 'azul';
        $ocultar_aulas = '';
        $ocultar_pagar = 'ocultar';
        $classe_progress = '';
        $icones_finalizados = 'ocultar';
    }else if($status == 'Instalação Encaminhada'){
        $excluir = 'ocultar';
        $icone = 'fa-square';       
        $classe_square = 'azul-claro';
        $classe_nome = 'azul';
        $ocultar_aulas = '';
        $ocultar_pagar = 'ocultar';
        $classe_progress = '';
        $icones_finalizados = 'ocultar';
    }else if($status == 'Instalação Concluída'){
        $excluir = 'ocultar';
        $icone = 'fa-square';       
        $classe_square = 'azul-escuro';
        $classe_nome = 'azul';
        $ocultar_aulas = '';
        $ocultar_pagar = 'ocultar';
        $classe_progress = '';
        $icones_finalizados = 'ocultar';
    }else if($status == 'Indicação Premiada'){
        $excluir = 'ocultar';
        $icone = 'fa-square';       
        $classe_square = 'verde_claro';
        $classe_nome = 'azul';
        $ocultar_aulas = '';
        $ocultar_pagar = 'ocultar';
        $classe_progress = '';
   ...
   // $data_cadastro_F = implode('/', array_reverse(explode('-', $data_cadastro)));
    $data_formatada_F = date('d/m/Y H:i', strtotime($data_cadastro));
    
    if ($status == 'Aguardando') {
        
       
       // var_dump($data_formatada_F);
...
<td class="esc">{$data_formatada_F}</td>
<td class="esc">{$status}</td>
<td>
    <big><a href="#" onclick="editar('{$id}','{$nome_ind}')" title="Editar nome Indicação"><i class="fa fa-edit verde"></i></a></big>
...
HTML;
 }elseif ($status == 'Instalação Encaminhada') {
    echo <<<HTML
<tr>
<td>
<i class="fa fa-square $classe_square"></i>
...
HTML;
 }elseif ($status == 'Instalação Concluída') {
    echo <<<HTML
<tr>
<td>
<i class="fa fa-square $classe_square"></i>
...
HTML;
 }elseif ($status == 'Indicação Premiada') {
    echo <<<HTML
<tr>
<td>
<i class="fa fa-square $classe_square"></i>
...
<script type="text/javascript">
    function editar(id, nome_ind, obs){
        $('#mensagem').text('');
